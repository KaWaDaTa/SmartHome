//
//  RemoteConnectionViewController.m
//  SCdemo
//
...
#import "RemoteConnectionViewController.h"

@interface RemoteConnectionViewController ()

@end

@implementation RemoteConnectionViewController
...
- (void)viewDidLoad {
    ...
    imageView.image = [UIImage imageNamed:@"远程连接英文.jpg"];
